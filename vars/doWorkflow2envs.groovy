...
def call(Map props = [:]) {
    ...
    node("rocket") {
        ...
        stage('Validate workflow') {
            sh "mvn com.stratio.rocket:rocket-maven-plugin:1.1.0-SNAPSHOT:validate -DrocketBaseUrl=$ROCKET_URL -Dcookie=$ROCKET_COOKIE -DassetVersionId=$ASSET_VERSION_ID -DreleaseId=$RELEASE_ID"
        }
